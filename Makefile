# This file was originally automagically generated by mbed.org. For more information, 
# see http://mbed.org/handbook/Exporting-To-GCC
# Tweaked by hand for Eclipse CDT.

MAVLINK_DIR = /opt/src/mavlink
GCC_BIN = 
PROJECT = xbm3pi-ugv
OBJECTS = StatusDisplay.o IMUfilter.o IMU.o USBSerial.o Rover.o TelemetryData.o Log.o IMUSensors.o System.o CommandDispatcher.o TelemetryEncoderMavLink.o CommandParser.o XBeeApi.o Gyro.o main.o Accelerometer.o m3pi/m3pi.o XBee/XBee.o 
...
CC_SYMBOLS = -DTARGET_LPC1768 -DTOOLCHAIN_GCC_CS -DNDEBUG -USERIES_2
