...
GCC_BIN = 
PROJECT = xbm3pi-ugv
OBJECTS = IMUfilter.o IMU.o USBSerial.o Rover.o TelemetryData.o Log.o IMUSensors.o System.o CommandDispatcher.o TelemetryEncoderMavLink.o CommandParser.o XBeeApi.o Gyro.o main.o Accelerometer.o m3pi/m3pi.o XBee/XBee.o 
