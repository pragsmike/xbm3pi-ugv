...
GCC_BIN = 
PROJECT = xbm3pi-ugv
OBJECTS = IMUSensors.o System.o CommandDispatcher.o TelemetryEncoderMavLink.o CommandParser.o XBeeApi.o Gyro.o main.o Accelerometer.o m3pi/m3pi.o XBee/XBee.o 
